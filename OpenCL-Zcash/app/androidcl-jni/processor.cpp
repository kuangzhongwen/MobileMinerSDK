...
JNIEXPORT jboolean JNICALL Java_so_opencl_LiveFeatureActivity_compileKernels(JNIEnv *env, jclass clazz)
{
    ...
    try {
        ...
        int src_length = 0;
		const char* src  = file_contents("/data/data/so.opencl/app_execdir/kernels.cl",&src_length);
...
JNIEXPORT void JNICALL Java_so_opencl_CameraPreview_runfilter(
        JNIEnv *env,
        jclass clazz,
        jobject outBmp,
        jbyteArray inData,
